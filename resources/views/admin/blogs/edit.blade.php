            ...
            <form action='{{ route('admin.blogs.update', ['blog' => $blog->id]) }}' method='post' enctype='multipart/form-data'>
                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="body" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" name="body" rows="5">{{ old('title', $blog->body) }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="js-pulldown" class="mr-6 w-full" name="category_id" multiple>
                            <option value="" disabled selected>選択してください</option>
